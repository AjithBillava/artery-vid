  ...
  const listCSS={
    ...
    return(
        ...
        <div className="list vertical-card">
            <NavLink className="horizontal align-center spaced-list-item" end  to="/" activeStyle={listCSS}>
            <svg viewBox="0 0 24 24"className="icon" focusable="false" ><g ><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8"></path></g>
            </svg>
             Home</NavLink>

            <NavLink className="align-center spaced-list-item" to="/history" activeStyle={listCSS}>
            ...
            History</NavLink>
            <NavLink className="align-center align-center spaced-list-item" to="/library" activeStyle={listCSS}>
            ...
            Library</NavLink>
            <NavLink className="align-center spaced-list-item" to="/liked-videos" activeStyle={listCSS}>
            ...
            <NavLink className="align-center spaced-list-item" to="/saved-videos" activeStyle={listCSS}>
          ...
          <NavLink className="align-center spaced-list-item" to="/playlist-videos" activeStyle={listCSS}>
