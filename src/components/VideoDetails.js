        ...
        <div className="main-layout "> 
            <div className="container center ">
                <div className="section ">
                    ...
                    onClick={()=>{checkItem(LikedVideos,video._id)? dataDispatch({type:REMOVE_FROM_LIBRARY,id:video._id}): dataDispatch({type:ADD_TO_LIKED_LIBRARY,video:video})}}
                    >
                    ...
                    onClick={()=>{checkItem(SavedVideos,video._id)? dataDispatch({type:UNSAVE_VIDEO,id:video._id}): dataDispatch({type:SAVE_VIDEO,video:video})}}>
